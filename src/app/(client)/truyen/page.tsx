	...
	return (
		<div className='container mx-auto w-10/12'>
			...
			<div className='container mb-3 flex flex-col gap-3 md:flex-row'>
				{/* Info truyện */}
				<div className='mx-auto grid w-full rounded border-2 p-3 md:m-0 md:w-8/12'>
					{/* Container 1 */}
				...
				{/* Nhóm đăng truyện */}
				<div className='flex w-full flex-col rounded-md border-2 bg-header-a md:w-4/12'>
					<div className='flex flex-row p-2'>
						...
						<div>
							<span className='text-white'>Trung Khiêm</span>
						</div>
					</div>
			...
			<div className='rounded border-2'>
				<div className='bg-header-a p-2'>
					<span className='text-white'>Tổng bình luận: 200</span>
				</div>
				<div className='mx-auto w-full p-2 md:w-10/12 lg:w-9/12'>
					<div className='mb-2'>
						<textarea className='w-full border-4' name='' id='' cols={30} rows={5}></textarea>
					</div>
					<div className='flex justify-end'>
						<button className='rounded bg-header-a p-2 text-white'>Đăng</button>
					</div>
				</div>
			</div>
		</div>
